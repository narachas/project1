...
if ((isset($_POST['insert'])))
{
	...
	$_SESSION['txtvis']=  $_POST['txtvis'];
	$_SESSION['txtddd']=  $_POST['txtddd'];
	$_SESSION['txtff']=   $_POST['txtff'];
	$_SESSION['txtwx']=   $_POST['txtwx'];
	$_SESSION['txtcld1']= $_POST['txtcld1'];
	$_SESSION['txtcld2']= $_POST['txtcld2'];
	$_SESSION['txtcld3']= $_POST['txtcld3'];
	$_SESSION['txtcld4']= $_POST['txtcld4'];
	$_SESSION['txtn1']=   $_POST['txtn1'];
	$_SESSION['txtn2']=   $_POST['txtn2'];
	$_SESSION['txtn3']=   $_POST['txtn3'];
	$_SESSION['txtn4']=   $_POST['txtn4'];
	$_SESSION['txtnn']=   $_POST['txtnn'];
	$_SESSION['txtttt']=  $_POST['txtttt'];
	$_SESSION['txttdd']=  $_POST['txttdd'];
	$_SESSION['txtqnh']=  $_POST['txtqnh'];
	...
	$txtff=   $_POST['txtff'];
	$txtwx=   $_POST['txtwx'];
	$txtcld1= $_POST['txtcld1'];
	$txtcld2= $_POST['txtcld2'];
	$txtcld3= $_POST['txtcld3'];
	$txtcld4= $_POST['txtcld4'];
	$txtn1=   $_POST['txtn1'];
	$txtn2=   $_POST['txtn2'];
	$txtn3=   $_POST['txtn3'];
	$txtn4=   $_POST['txtn4'];
...
{
	$sql=mysql_query("Select * from metar where dte = '$txtddate' and  utc = '$txtutc' ");
	if (mysql_num_rows($sql) > 0) 
	{
	$result = mysql_query("Select * from metar where dte = '$txtddate' and  utc = '$txtutc' "); 
