...
{
echo "<script>sAlert('Going for insert 111');</script>";
...
<tr>
		...
		<td><input type='text' name='txtclht1' id = 'txtclht1' tabindex="5" width='50' maxlength="3" value='<?php echo $txtclht1;?>'> </td>
</tr>
<tr>
		...
		<td><input type='text' name='txtclht2' id = 'txtclht2' tabindex="5" width='50' maxlength="3" value='<?php echo $txtclht2;?>'> </td>
</tr>
...
<tr>
		...
		<td><input type='text' name='txtclht3' id = 'txtclht3' tabindex="5" width='50' maxlength="3" value='<?php echo $txtclht3;?>'> </td>
</tr>
...
<tr>
		...
		<td><input type='text' name='txtclht4' id = 'txtclht4' tabindex="5" width='50' maxlength="3" value='<?php echo $txtclht4;?>'> </td>
</tr>
<tr height="20"></tr>
<tr>
