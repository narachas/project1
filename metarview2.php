...
mysql_select_db("wx");
$sql=mysql_query("Select * from metar order by dte, utc");
if (mysql_num_rows($sql) > 0) 
{
	...
	$txtn4		=  $row['txtn4'];
	$txtnn		=  $row['txtnn'];
	$txtclht1 	=  $row['txtclht1'];
	$txtclht2 	=  $row['txtclht2'];
	$txtclht3 	=  $row['txtclht3'];
	$txtclht4 	=  $row['txtclht4'];
	$txtttt		=  $row['txtttt'];
	$txttdd		=  $row['txttdd'];
	$txtqnh		=  $row['txtqnh']; 
...
//Dry
wtext("32.2",20,50,"blue",mycan);
//Dewpoint
wtext("28.1",20,80,"#c61f03",mycan);
//Visibility
